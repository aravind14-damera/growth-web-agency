    ...
    return (
        <div className="min-h-screen w-full flex bg-black">
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center bg-zinc-900">
                ...
                >
                    <h2 className="text-5xl font-bold text-white mb-6">Join Growth</h2>
                    <p className="text-xl text-zinc-400 max-w-md mx-auto">
                        Start building the future today. Create an account to launch your next big project.
                    </p>
                </motion.div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                <Link
                    href="/"
                    className="absolute top-8 left-8 text-zinc-400 hover:text-gold flex items-center gap-2 transition-colors"
                >
                ...
                >
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-zinc-400 mt-2">Enter your details to get started</p>
                    </div>

                    <div className="space-y-4">
                        <button className="w-full flex items-center justify-center gap-3 bg-white text-black h-12 rounded-lg font-medium hover:bg-zinc-200 transition-colors">
